...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '此生谁共？天地与我。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://felix1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Felix, InsightfulReflections, KnowledgeHub, WorldExplorer', // 网站关键词 英文逗号隔开
